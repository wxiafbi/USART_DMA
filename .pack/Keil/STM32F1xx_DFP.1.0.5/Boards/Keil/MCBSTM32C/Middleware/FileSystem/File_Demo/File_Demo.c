...
static void init_display () {
  ...
  GLCD_DisplayString (0, 0, __FI, "      MCBSTM32C     ");
  GLCD_DisplayString (1, 0, __FI, "  Evaluation Board  ");
  GLCD_DisplayString (3, 0, __FI, "      MDK-ARM       ");
  GLCD_DisplayString (4, 0, __FI, " File_Demo example  ");
}
...
static void init_filesystem (void) {
  ...
  printf ("Initializing enabled drives...\n\n");
